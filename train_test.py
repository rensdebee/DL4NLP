...
def main(args: argparse.Namespace):
    ...
    def read_train_test():
        ...
        ds_train = Dataset.from_pandas(pd.DataFrame(train_dataset, columns=["answer", "label"]))
        ds_test = Dataset.from_pandas(pd.DataFrame(test_dataset, columns=["answer", "label"]))
